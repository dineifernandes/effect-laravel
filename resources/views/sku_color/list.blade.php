...
@section('title', 'Cores SKU')
@section('page-name', 'Cores SKU')
    ...
    <div class="card">
        <div class="card-body">
            <div class="d-md-flex gap-4 align-items-center">
                ...
                <a href="{{route('sku.create')}}" class="btn btn-link btn-icon">
    ...
    <div class="table-responsive">
        <table id="users" class="table table-custom table-lg">
            ...
            <tr>
                ...
                <td>1</td>
                <td><a href="#">Azul</a></td>
                <td><div style="background-color: #0d6efd; width: 30px; height: 30px">&nbsp;</div></td>
            ...
            <tr>
                ...
                <td>2</td>
                <td><a href="#">Vermelho</a></td>
                <td><div style="background-color: #ff0d00; width: 30px; height: 30px">&nbsp;</div></td>
                <td>10/10/2024 07:02:00</td>
                <td>12/10/2024 10:32:00</td>
                <td>
