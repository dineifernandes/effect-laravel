...
@section('page-name', 'Categoria')

@section('content')
    <div class="card mb-4">
        <div class="card-body">
            <h6 class="card-title mb-4">Controle de Categoria</h6>
            <form class="row" method="post" action="{{route('category.store')}}">
                ...
                <div class="d-flex flex-fill justify-content-end">
                    <a href="{{ route('category.index')  }}" class="btn btn-outline-dark btn-icon me-2" data-bs-toggle="tooltip" title="Cancelar">
