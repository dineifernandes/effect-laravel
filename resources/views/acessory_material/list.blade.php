...
@section('title', 'Materiais Acessórios')
@section('page-name', 'Materiais Acessórios')
    ...
    <div class="card">
        <div class="card-body">
            <div class="d-md-flex gap-4 align-items-center">
                ...
                <a href="{{route('acessorymaterial.create')}}" class="btn btn-link btn-icon">
