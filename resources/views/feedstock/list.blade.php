...
@section('title', 'Matérias Prima')
@section('page-name', 'Matérias Prima')
    ...
    <div class="card">
        <div class="card-body">
            <div class="d-md-flex gap-4 align-items-center">
                ...
                <a href="{{route('feedstock.create')}}" class="btn btn-link btn-icon">
    ...
    <div class="table-responsive">
        <table id="users" class="table table-custom table-lg">
            ...
            <tr>
                ...
                <td>1</td>
                <td><a href="#">Matéria Prima 01</a></td>
            ...
            <tr>
                ...
                <td>2</td>
                <td><a href="#">Matéria Prima 02</a></td>
                <td>10/10/2024 07:02:00</td>
                <td>12/10/2024 10:32:00</td>
                <td>
