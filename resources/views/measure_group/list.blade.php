...
@section('title', 'Grupos de Medidas')
@section('page-name', 'Grupos de Medidas')
    ...
    <div class="card">
        <div class="card-body">
            <div class="d-md-flex gap-4 align-items-center">
                ...
                <a href="{{route('measuregroup.create')}}" class="btn btn-link btn-icon">
