<template>
    ...
    <AppLayout title="Etiqueta">
        <div class="card">
            <div class="card-body">
                <h6 class="card-title mb-4">Editar Etiqueta</h6>
...
export default defineComponent({
    ...
    data(props) {
        ...
        const form = useForm(props.etiqueta)
    ...
    methods: {
        async submitForm(){
            ...
            if (isValid) {
                ...
                try{
                    const response = await this.form.put(route('tag.update', this.form.id));
        ...
        validateForm(form) {
          return !(!form.id || form.nome === '' || form.status === '' || form.duracao_etiqueta === '');
        }
    }
});
</script>
