<template>
    ...
    <AppLayout title="Acessório/Material">
        <div class="card">
            <div class="card-body">
                <h6 class="card-title mb-4">Editar Acessório/Material</h6>
                ...
                <form class="row" method="post" @submit.prevent="submitForm">
                    ...
                    <div class="d-flex flex-fill justify-content-end">
                        <Link :href="route('acessorymaterial.index')" class="btn btn-outline-dark btn-icon me-2" data-bs-toggle="tooltip" title="Cancelar">
...
export default defineComponent({
    ...
    data(props) {
        ...
        const form = useForm(props.acessorio)
    ...
    methods: {
        async submitForm(){
            ...
            if (isValid) {
                ...
                try{
                    const response = await this.form.put(route('acessorymaterial.update', this.form.id));
