<template>
    ...
    <AppLayout title="Matéria Prima">
        <div class="card">
            <div class="card-body">
                <h6 class="card-title mb-4">Editar Matéria Prima</h6>
                ...
                <form class="row" method="post" @submit.prevent="submitForm">
                    ...
                    <div class="d-flex flex-fill justify-content-end">
                        <Link :href="route('feedstock.index')" class="btn btn-outline-dark btn-icon me-2" data-bs-toggle="tooltip" title="Cancelar">
    ...
    methods: {
        async submitForm(){
            ...
            if (isValid) {
                ...
                try{
                    const response = await this.form.put(route('feedstock.update', this.form.id));
